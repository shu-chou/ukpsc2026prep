...
import { computerTopics } from './computer';
import { csatTopics } from './csat';
...
export const allIndiaNotes = {
  ...
  science: { label: 'Science & Technology', topics: scienceTopics },
  computer: { label: 'Computer & IT', topics: computerTopics },
  csat: { label: 'CSAT / Aptitude', topics: csatTopics }
};
