...
export const uttarakhandSections = [
  ...
  { slug: 'schemes-development', name: 'Schemes & Development', icon: '🏗', desc: 'State-specific schemes, development programmes, institutions and flagship initiatives.', topics: ['State Government Schemes', 'Central Schemes with Uttarakhand Relevance', 'Development Plans', 'Infrastructure Initiatives', 'Rural Development', 'Urban Development', 'Women & Child Development', 'Youth & Employment'], status: 'Building' },
  ...
  { slug: 'misc-gk', name: 'Miscellaneous GK', icon: '🏆', desc: 'Small but recurring state-specific facts that do not fit cleanly elsewhere.', topics: ['State Symbols', 'Important Places', 'Important Personalities', 'Sports', 'Awards & Honours', 'Books & Authors', 'Firsts & Records', 'Important Institutions'], status: 'Building' }
];
