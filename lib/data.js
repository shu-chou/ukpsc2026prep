...
export const uttarakhandSections = [
  ...
  { slug: 'movements', name: 'Movements', icon: '✊', desc: 'Major social, forest, political and statehood movements with their causes, leaders and outcomes.', topics: ['Coolie-Begar Movement', 'Dola-Palki Movement', 'Forest Movements', 'Chipko Movement', 'Anti-Tehri / Other Regional Movements', 'Uttarakhand Statehood Movement'], status: 'To build' },
