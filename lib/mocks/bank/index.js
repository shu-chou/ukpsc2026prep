...
const sources = [ukGeography, ukHistory, ukMovements, ukPolityAdministration, ukEconomyDevelopment, indianPolityBank, ukSocietyCulture, ukEnvironmentResources, ukSchemesDevelopment, ukMiscGK, historyBank, geographyBank];
