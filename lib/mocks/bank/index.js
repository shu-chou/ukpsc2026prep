...
import { economyBank } from './economy';
import { environmentBank } from './environment';
import { scienceBank } from './science';
import { computerBank } from './computer';
import { csatBank } from './csat';
...
const sources = [ukGeography, ukHistory, ukMovements, ukPolityAdministration, ukEconomyDevelopment, indianPolityBank, ukSocietyCulture, ukEnvironmentResources, ukSchemesDevelopment, ukMiscGK, historyBank, geographyBank, economyBank, environmentBank, scienceBank, computerBank, csatBank];
